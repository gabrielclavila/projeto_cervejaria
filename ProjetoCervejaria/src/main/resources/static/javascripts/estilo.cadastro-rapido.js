...
Cervejaria.EstiloCadastroRapido = (function() {
	...
	function EstiloCadastroRapido() {
		...
		//Evitando submeter o formulário ao clicar na tecla Enter
	...
	function onBotaoSalvarClick(){
		...
		//console.log('nome estilo', nomeEstilo); //Para visualizar no Console do navegador se o valor inserido no input do texto está sendo capturado
		$.ajax({
			url: this.url,
			method: 'POST',
