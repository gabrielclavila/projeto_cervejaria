package com.algaworks.cervejaria.thymeleaf.processor;
...
public class MessageElementTagProcessor extends AbstractElementTagProcessor{
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		structureHandler.replaceWith(model, true); //Como estamos trabalhando com o Thymeleaf é passado o valor True, se fosse somente HTML que é mais estático seria passado o valor False
	}
